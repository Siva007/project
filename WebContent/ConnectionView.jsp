...
function validate()
{
var mystring= document.viewconnection.customerId.value;
var numcheck=/^[0-9]*$/;
if(mystring.length!=6){
	alert("Please enter 6 digit Customer Id");
	return false;
}
...
<body topmargin="0" background="bg.gif" leftmargin="0" style="text-align: left; word-spacing: 0; line-height: 100%; margin-top: 0; margin-bottom: 0" onload="dynAnimation()">
    ...
    <a href="home.html" style="text-decoration: none"><font color="#FFFF00">
     ...
     <a style="text-decoration: none" href="home.html">
     <font color="#FFFF00" onmouseover="this.style.color='white'" onmouseout="this.style.color='#FFFF00'">Help Desk</font></a></font>
     ...
     <a style="text-decoration: none" href="home.html"> 
       ...
       <iframe src="http://free.timeanddate.com/clock/i392spca/n1892/fn15/fcfff/tc000/tt0/tw0/tm1/ta1/tb2" frameborder="0" width="184" height="18"></iframe>
</a><a href="home.html" style="text-decoration: none"><font color="#FFFF00" onmouseover="this.style.color='white'" onmouseout="this.style.color='#FFFF00'" face="Arial" size="2">&nbsp;</font></a>
     </td>
     </tr>
     </table>
     </td>
     ...
     <tr>
     <td width="672" height="14" bgcolor="#FFFFFF" style="border-left-style: solid; border-left-width: 1">&nbsp;
     </td>
     <td width="388" height="14" bgcolor="#FFFFFF"  style="border-right-style:solid; border-right-width:1">&nbsp;
     </td>
     </tr>
  ...
  <ul id="createawebsite1">
   ...
   <li><a href="CustomerUIStart.jsp">Add Customer</a></li>
   <li><a href="CustomerViewByAdminUI.html">View Customer</a></li>
   <li><a href="CustomerUpdateUI.html">Update Customer</a></li>
<li><a href="CustomerDeleteUI.html">Delete Customer</a></li>
...
<td height="330" bgcolor="#FFFFFF" width="550" style="border-bottom-style: solid; border-bottom-width: 1;border-right-style:solid; border-right-width:1 "valign="top">
        <table border="0" cellspacing="0" width="101%" cellpadding="0" height="1" style="border-left-width: 0; border-bottom-width: 0; border-collapse:collapse" bordercolor="#111111">
          ...
          <tr>
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
           View Connection Details</b></font></td>
...
<form name="viewconnection" action="ConnectionControllerD" method="post" onsubmit="return validate();">
<input type="hidden" value="customerview" name="option">
</input>
...
<input type="submit"  value="Submit"/>
          ...
          <tr>
            <td width="2%" height="18" bordercolor="#FFFFFF" style="border-left-style: solid; border-left-width: 1; border-bottom-style:none; border-bottom-width:medium; border-right-style:solid; border-right-width:1"></td>
