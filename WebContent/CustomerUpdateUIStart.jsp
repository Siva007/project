...
<script type="text/javascript" src="CustomerIdCheckUpdate.js">
</script>
...
<td height="410" bgcolor="#FFFFFF" width="530" valign="top" >
        <table border="0" bgcolor="#89CFF0"cellspacing="0" width="410" cellpadding="0" height="1" style="border-left-width: 0; border-bottom-width: 0; border-collapse:collapse" bordercolor="#111111">
          ...
          <tr>
            ...
            Update Customer Details</b></font></td>
...
<tr valign="middle">
<td align="center">
<form name="updatecustomer" action="CustomerController" method="post">
<input type="hidden" name="operation" value="viewforupdate">

Enter Customer Id <input type="text" name="customerId" />
<br></br>
<input type="submit"  value="Submit" Onclick=" return master()" />
</form>
