...
<title>Complete Customer Registration</title>
<script>
function myFunction()
{
...
<script type="text/javascript" src="Fillproofs.js">
</script>
...
<td height="410" bgcolor="#FFFFFF" width="530" valign="top" >
        <table border="0" bgcolor="#89CFF0"cellspacing="0" width="410" cellpadding="0" height="1" style="border-left-width: 0; border-bottom-width: 0; border-collapse:collapse" bordercolor="#111111">
          ...
          <tr>
            ...
            Complete The Registration</b></font></td>
...
<h3><font color="blue">Fill The Proofs</font></h3><br></br>

<table>
<tr><td>Id Proof<font color="red">*</font>:  </td><td><select name="idproof">
<option value="Id Skip"> Skip</option>
<option value="Passport">Passport</option>
<option value="Pan Card">Pan Card</option>
<option value="Voter Id">Voter Id</option></select></td></tr>
<tr>
<td>Id Image<font color="red">*</font>:</td><td><input type="file" name="image" ></input></td>
</tr>
<tr><td>Address Proof<font color="red">*</font>:  </td><td><select name="AddressProof">
<option value="Address Skip"> Skip</option>
<option value="Passport">Passport</option>
<option value="Pan Card">Pan Card</option>
<option value="Voter Id">Voter Id</option></select></td></tr>

<tr>
<td>Address Image <font color="red">*</font>:</td><td><input type="file" name="AddressImage" ></input></td>
</tr>
</table>
<input type="hidden" name="regis" value="regis"/>
<input type="Submit" value="Submit" Onclick=" return chk_image()"></input> 
</form>
