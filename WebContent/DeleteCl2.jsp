...
<a class="stable1" href="Login2Controller?operation=logout">
     ...
     <tr>
     <td width="180" height="421" bgcolor="#FFFFFF" valign="top" >
...
<td height="410" bgcolor="#FFFFFF" width="530" valign="top" >
		...
		<h3> Delete Call Details</h3>
		
		<table>
		<tr valign="middle">
		<form method="post" action="CallDetailsControllerD">
		<input type="hidden" name="checkpage" value="viewall3"/>
		
		
		<td align="center">
		<input type="submit" class="button" value="Delete" onclick="DeleteCl.jsp"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		</form>
		</td>
		<td align="center">
