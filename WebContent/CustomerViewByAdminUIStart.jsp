...
<a class="stable1" href="Login2Controller?operation=logout">
     ...
     <table bgcolor="#89CFF0" border="0" cellpadding="2" style="border-collapse: collapse" bordercolor="#111111" width="100%" height="486">
...
<td height="410" bgcolor="#FFFFFF" width="530" valign="top" >
        <table border="0" bgcolor="#89CFF0"cellspacing="0" width="410" cellpadding="0" height="1" style="border-left-width: 0; border-bottom-width: 0; border-collapse:collapse" bordercolor="#111111">
          ...
          <tr>
            ...
            View Customer Details</b></font></td>
          ...
          <tr>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse" bordercolor="#111111" height="221">
              ...
              <tr>
                ...
                <table width="550" height="469" bgcolor="#D3EDF1">
<tr valign="middle">
<td align="center">
<form name="customerviewbyadmin" action="CustomerController" method="post">
<input type="hidden" name="operation" value="viewAllCustomer"/>
<input type="submit" value="View All Customer Details"/>
</form>
<br></br>
<form name="customerviewbyadmin1" action="CustomerController" method="post">

<input type="hidden" name="operation" value="viewSingleCustomerPage"/>
<input type="submit" value="View Single Customer Details"/>
</form>
