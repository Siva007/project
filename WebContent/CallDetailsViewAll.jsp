...
<input type="hidden" name="checkpage" value="viewall"></input></td>
</tr>
<tr>
<td >
<input type="submit" class="button" value="View all" onclick="ViewId.jsp"></input></td>
<td>&nbsp;</td>
