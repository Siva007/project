...
function validate()
{
var mystring= document.deleteconnection.connectionNumber.value;
var numcheck=/^[0-9]*$/;
if(mystring.length!=10){
	alert("Please enter 10 digit Connection Number");
	return false;
}
if(!(numcheck).test(mystring)){
	alert("Please enter a proper number format for Connection Number");
	return false;
}
return true;
}
...
<a class="stable1" href="Login2Controller?operation=logout">
     ...
     <table bgcolor="#89CFF0" border="0" cellpadding="2" style="border-collapse: collapse" bordercolor="#111111" width="100%" height="465">
...
<td height="410" bgcolor="#FFFFFF" width="530" valign="top" >
        <table border="0" bgcolor="#89CFF0"cellspacing="0" width="410" cellpadding="0" height="1" style="border-left-width: 0; border-bottom-width: 0; border-collapse:collapse" bordercolor="#111111">
          ...
          <tr>
            ...
            Delete Connection Details</b></font></td>
		...
		<table align="center" width="550" height="404">
		<tr valign="middle">
		...
		<input type="hidden" name="option" value="deleteconnection">
		


		Enter Connection Number <input type="text" name="connectionNumber" maxlength="10"/> 
