...
<title>Customer Registration By Admin</title>
...
<a class="stable1" href="Login2Controller?operation=logout">
     ...
     <table bgcolor="#89CFF0" border="0" cellpadding="2" style="border-collapse: collapse" bordercolor="#111111" width="100%" height="502">
...
<td height="410" bgcolor="#FFFFFF" width="530" valign="top" >
        <table border="0" bgcolor="#89CFF0"cellspacing="0" width="410" cellpadding="0" height="1" style="border-left-width: 0; border-bottom-width: 0; border-collapse:collapse" bordercolor="#111111">
          ...
          <tr>
            ...
            Customer Registration</b></font></td>
...
<table width="550" height="485" bgcolor="#D3EDF1">
<tr valign="middle">
<td align="center">
...
<tr><td>Address<font color="red">*</font>:  </td><td><textarea name="address" rows="4" cols="20"></textarea></td></tr>
...
<tr><td>(sample@gmail.com)</td></tr>

<tr><td>Do you want to fill the proofs? </td><td><input type="radio" name="fillp" value="Skip" />Skip
<input type="radio" name="fillp" value="Fill"/>Fill</td></tr>


<input type="hidden" value="addcust" name="operation"/>
...
<input type="Submit" value="Submit" Onclick=" return master()">&nbsp;&nbsp;&nbsp;<input type="reset" value="Reset">
</center>
<br/>
...
<center> <b>Note: All fields marked <font color="red">*</font> are Mandatory</b></center>
        ...
        <tr  style="border-left-style: solid; border-left-width: 1 " bordercolor="#FFFFFF">
            ...
            contact</font><font size="1" face="Verdana" color="#003366">
            <a style="text-decoration: underline; font-family: Arial; color: #0000ff" href="#">
            </a> </font>
