...
<script type="text/javascript" src="CompleteRegis.js">
</script>
...
<tr valign="middle">
<td align="center">
<form name="updatereg" action="CustomerController" method="post">
<input type="hidden" name="operation" value="updateforreg">

<table border="1">
<input type="hidden" name="ack" value="<%=(request.getAttribute("ackid"))%>"></input>
<input type="hidden" name="custname" value="<%=(request.getAttribute("name"))%>"></input>
<input type="hidden" name="address" value="<%=(request.getAttribute("add"))%>"></input>
...
<input type="hidden" name="contact" value="<%=(request.getAttribute("num"))%>"></input>
<input type="hidden" name="email" value="<%=(request.getAttribute("mail"))%>"></input>
<tr>
<td>Acknowledgment Id: </td>
<td><%out.println(request.getAttribute("ackid")); %></td>
</tr>
<tr>
<td>Customer Name: </td>
<td>
...
<center><input type="submit"  value="Continue" Onclick=" return master()"/></center>
<br></br>
