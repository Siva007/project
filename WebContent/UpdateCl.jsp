    ...
    function openpage()
    {
  	  var radioObj = document.butval.radio;     
  		...
  		for(var i=0; i<radioObj.length; i++) 
		     ...
		     alert("please select a record to view details"); 
  		   return false; 
  		}
</script>
...
<a class="stable1" href="Login2Controller?operation=logout">
     ...
     <table bgcolor="#89CFF0" cellpadding="2"  height="582" bordercolor="#89CFF0">
     <tr valign="top">
...
<td height="410" bordercolor="#89CFF0" width="530" valign="top" >
        <table border="0" bgcolor="#89CFF0" cellspacing="0" width="410" cellpadding="0" height="1" >
          ...
          <tr>
            <td width="2%" height="26" bordercolor="#89CFF0" >&nbsp;</td>
            ...
            Updating Call Details</b></font></td>
            <td width="3%" height="26">&nbsp;</td>
          </tr>
          <tr>
            <td width="2%" height="20" bordercolor="#89CFF0" >&nbsp;</td>
            <td width="99%" height="20" valign="top">&nbsp;</td>
            
          </tr>
          <tr>
            <td width="2%" height="154" bordercolor="#89CFF0" >&nbsp;</td>
            <td width="98%" height="154" valign="bottom" bgcolor="#F4F4F4" bordercolor="#C0C0C0">
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse" bordercolor="#89CFF0" height="221">
              ...
              <tr>
                ...
                <table width="530" height="404" bgcolor="#D3EDF1">
                <tr valign="middle">
                

                <td align="center" > 
                 
<center><p><h3>Update Call Details</h3></p></center>
<table width="200"> <tr><td>
        <center><input name="radio"  type="radio" id="rad" onclick="displayTextBox2()"/><label for="choice2"><font color="black"> Search By Call ID  </font></label></center><br>
...
<td height="65"><center>
                ...
                <input type="hidden" name="checkpage" value="id1"/></INPUT>
                <font color="#FFAEB9">Enter Call ID  </font><input type="text" name="ID" maxlength="4">
                <INPUT TYPE="submit" class="button" value="Search"></INPUT>
                <input type="reset" class="button" value="Cancel" onclick='return hideTextBox2()'/>
                </form>
...
<%
   ...
   if(clist!=null){
%><div style="height:210px;width:535px;border:1px solid #ccc;overflow:scroll;">
...
<a href='CallDetailsControllerD?callId=<%=clist.get(i).getCallid()%>&checkpage=update'>
<tr ONMOUSEOVER="this.style.backgroundColor='skyblue'" ONMOUSEOUT="this.style.backgroundColor='#D3EDF1'" title="click call ID to Update the Call Details">
...
<input type="submit" class="button" value="Cancel" ></input>
          ...
          <tr >
            <td bgcolor="#89CFF0" width="2%" height="30" bordercolor="#89CFF0" ></td>
        ...
        <tr  style="border-left-style: solid; border-left-width: 1 "bordercolor="#89CFF0">
            <td width="2%" height="26" bordercolor="#89CFF0" >&nbsp;</td>
