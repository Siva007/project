...
<script type="text/javascript" src="validateUpdation.js">
</script>
...
<form name="regform" action="UploadImageController" method="post" enctype="multipart/form-data">
<input type="hidden" name="operation" value="updateCustomer">




<input type="hidden" name="customerId" value="<%=(request.getAttribute("cid"))%>"></input>
<input type="hidden" name="custname" value="<%=(request.getAttribute("name"))%>"></input>

<input type="hidden" name="dob" value="<%=(request.getAttribute("dob"))%>"></input>
<input type="hidden" name="sex" value="<%=(request.getAttribute("gen"))%>"></input>
...
<input type="hidden" name="checkadd" value="<%=(request.getAttribute("address"))%>"></input>

<table>

<tr>
<td> Customer Id<font color="red">*</font>:</td><td><input type="text" name="cid" value="<%out.println(request.getAttribute("cid")); %>" disabled="disabled" /></td>
</tr>



<tr>
<td>Customer Name<font color="red">*</font>:</td><td><input type="text" name="name" value="<%out.println(request.getAttribute("name")); %>" disabled="disabled" /></td>
</tr>


<tr><td>Address<font color="red">*</font>:</td><td><textarea name="address" rows="5" cols="30"><%out.println(request.getAttribute("add"));%></textarea></td></tr>

<tr>
<td>Date of Birth<font color="red">*</font>:<br/>(dd/mm/yyyy)</td><td><input type="text" name="dob" value="<% out.println(request.getAttribute("dob"));%>" disabled="disabled"/></td>
</tr>   
<%if(request.getAttribute("gen").equals("male"))
	{%>

<tr><td>Gender<font color="red">*</font>:  </td><td><input type="radio" name="gender" value="male"  value="<%out.println(request.getAttribute("gen")); %>" checked=" checked"  disabled="disabled"></input>Male
<input type="radio" name="gender" value="female"  value="<%out.println(request.getAttribute("gen"));%>" disabled="disabled"/>Female</td></tr>

<%}
else
{%>
<tr><td>Gender<font color="red">*</font>:  </td><td><input type="radio" name="gender" value="male"  value="<%out.println(request.getAttribute("gen")); %>"  disabled="disabled"></input>Male
<input type="radio" name="gender" value="female"  value="<%out.println(request.getAttribute("gen"));%>" checked=" checked" disabled="disabled"/>Female</td></tr>
...
<tr>
<td>Contact Number<font color="red">*</font>:</td><td><input type="text" name="contact" value="<% out.println(request.getAttribute("num"));%>"/></td>
</tr>   

  <tr>
<td>Email Id<font color="red">*</font>:</td><td><input type="text" name="email" value="<% out.println(request.getAttribute("mail"));%>"/></td>
</tr> 



<tr><td>Address Proof:  </td><td><select name="addressProof">
<option value="<% out.println(request.getAttribute("addressProof"));%>"> <% out.println(request.getAttribute("addressProof"));%></option>
<option value="Passport">Passport</option>
<option value="Pan Card">Pan Card</option>
<option value="Voter Id">Voter Id</option></select></td></tr>




<tr>
<td>Address Image :</td><td><input type="file" name="addressImage"></input></td>
</tr>

           
</table>

<center><input type="submit"  value="Submit" Onclick=" return master()"/></center>
