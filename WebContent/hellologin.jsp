...
<script type="text/javascript" src="ConnectionUIScript.js"></script>
</head>
...
<li><a href="CallDetailsViewAll.jsp">View CallDetails</a></li>
<li><a href="UpdateCl2.jsp">Update CallDetails</a></li>
<li><a href="DeleteCl2.jsp">Delete CallDetails</a></li>
          ...
          <tr>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse" bordercolor="#111111" height="221">
              ...
              <tr>
                ...
                <td  align="center">                
<form name="connectionForm" method="post" action="ConnectionControllerD" >

<input type="hidden" value="issue" name="option"/>
...
<td>
Bill Type E bill or Paper Bill
</td>
<td valign="middle">
<input type="radio" name="btype" value="Electronic Bill"> E-Bill
...
<select name=bplan>
  ...
  <option value="plan150"> plan150</option>
  <option value="plan250"> plan250</option>
  <option value="plan500"> plan500</option>
  </select> <br />
</td>
...
<tr>
<td>
<input type="submit" value="Issue" onclick="return check()">
</input>
</td>
<td>
