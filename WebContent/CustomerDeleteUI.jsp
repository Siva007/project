...
var r=confirm("Press OK to delete the customer");
if (r==true)
  {
return true;
  }
...
<form name="deleteform" action="CustomerController" method="post">
...
<form name="deleteform2" action="CustomerController" method="post">
...
<form name="deleteform3" action="CustomerController" method="post">
<input type="hidden" name="operation" value="deleteCustomer"/>
<input type="hidden" name="id" value="<%=request.getAttribute("custid")%>"/>

<center><input type="submit"  value="DELETE" onclick="return myFunction()"/></center>
