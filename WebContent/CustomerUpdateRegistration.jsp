...
<script type="text/javascript" src="AckIdCheckUpdateRegis.js">
</script>
...
<tr valign="middle">
<td align="center">
<form name="updateregis" action="CustomerController" method="post">

<input type="hidden" name="operation" value="viewupdateregis">

Enter Acknowledgment Id <input type="text" name="ackid" />
<br></br>
