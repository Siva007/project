...
<title>Call Details Upload</title>

<script type="text/javascript">
function validate()
{
var mystring=document.form.upfile.value;
var ext = mystring.substring(mystring.lastIndexOf('.') + 1);
if(mystring=="" )
{
...
<a class="stable1" href="Login2Controller?operation=logout">
       <font color="#FFFF00" onmouseover="this.style.color='white'" onmouseout="this.style.color='#FFFF00'">Logout</font></a>&nbsp; |&nbsp;&nbsp;
        <a class="stable1" href="ContactUs.jsp">       <font color="#FFFF00" onmouseover="this.style.color='white'" onmouseout="this.style.color='#FFFF00'">Contact Us</font></a></font></td>
...
<table width="550" height="404" bgcolor="#D3EDF1">
                <tr valign="middle">
                <td align="center">                
<form name=form method="POST" onsubmit="return validate()" enctype="multipart/form-data" action="UploadCallDetailsController" ><center>

Browse the file to upload:&nbsp;&nbsp;&nbsp;<INPUT TYPE=FILE class="button" name="upfile"  >
...
<center>
<input type="hidden" name="checkpage" value="upload">
