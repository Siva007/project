...
<a href='ConnectionControllerD?id=viewbyidadmin&option=viewbyidadmin'>View By ConnectionNumber</a><br></br>
<a href='ConnectionControllerD?id=viewalladmin&option=viewalladmin'>View All</a>

<!-- <form action="ConnectionControllerD" method="post">
<input type="hidden" value="viewbyidadmin" name="option"/>

<input type="submit" value="View By connectionNumber" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<input type="hidden" value="viewalladmin" name="option1">
</input>
