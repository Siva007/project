...
<%
ArrayList<ConnectionIssue> clist=new ArrayList<ConnectionIssue>();
clist = (ArrayList<ConnectionIssue>)request.getAttribute("connList");
...
<tr>
<td>Customer Id: </td>
<td><%=clist.get(0).getCustomerId()%></td>
</tr>
...
<td>
<%=clist.get(0).getConnectionNumber()%>
</td>
...
<tr>
<td>Tariff Type: </td>
<td><%=clist.get(0).gettCode()%></td>
	
</tr>

<tr>
<td>Status: </td>
<td><%=clist.get(0).getStatus()%></td>
</tr>
