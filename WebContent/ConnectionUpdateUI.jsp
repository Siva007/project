...
<%@ page language="java" 
 ...
 <%@page import="com.tcs.model.BTSS" %>
  <%@page import="java.util.ArrayList" %>
     ...
     <%@page import="com.tcs.model.Tariff" %>
<html>
...
<td height="410" bgcolor="#FFFFFF" width="530" valign="top" >
        <table border="0" bgcolor="#89CFF0"cellspacing="0" width="410" cellpadding="0" height="1" style="border-left-width: 0; border-bottom-width: 0; border-collapse:collapse" bordercolor="#111111">
          ...
          <tr>
            ...
            Update Connection Details</b></font></td>
...
ArrayList<Tariff> tList=new ArrayList<Tariff>();
tList = (ArrayList<Tariff>)request.getAttribute("tarList");



%>
<form name="connectionForm" action="ConnectionControllerD" method="post" onsubmit="return check()">
<input type="hidden" name="option" value="finalupdate">
...
if(c.get(0).getBillType().equals("Electronic Bill"))
		{
	%>
	<input type="radio" name="btype" value="<%out.println(c.get(0).getBillType());%>" checked> Electronic Bill
	<input type="radio" name="btype" value="Paper Bill" > Paper Bill<br></br>
	<%
			}
else{
	%>
<input type="radio" name="btype" value="Electronic Bill" > Electronic Bill<br></br>
<input type="radio" name="btype" value="<%out.println(c.get(0).getBillType());%>" checked> Paper Bill<br></br>
...
for(Tariff t:tList)
{%>
	<option value="<%out.println(t.getTcode());%>"> 
	<%out.println(t.getTcode());%></option>
<%}%>
  </select>
</td>
</tr>
