...
<td align="center">
			...
			<h3>Congratulations <font color=blue><%out.println(request.getAttribute("name")); %></font> on registration.</h3>
			
			<h3>Your Login Details :</h3>
			
			Acknowledgment Id : <%out.println(request.getAttribute("ackid")); %><br></br>
			
			Please submit id and address proofs within 10 days.
