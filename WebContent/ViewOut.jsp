...
<div id="content">
      <br>
<%
	CallDetails cd =(CallDetails)request.getAttribute("con");
%>


                             
<center><h3>Call Details</h3></center>

<table border="1" cell padding="10" cell spacing="15" width="350">


				
		
			<tr >
				<td>Call ID</td><td><%= cd.getCallid() %></td>
				</tr>
				<tr>
				<td>Date of call</td><td><%= cd.getDoc()%></td>
				</tr>
				<tr>
			   <td>Duration</td><td><%= cd.getDuration()%></td>
			   </tr>
			   <tr>
				<td>Dialed number</td><td><%= cd.getDialno()%></td>
				</tr>
				<td>Type of call</td><td><%= cd.getCalltype()%></td>
				</tr>
