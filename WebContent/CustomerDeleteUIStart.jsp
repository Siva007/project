...
<script type="text/javascript" src="CustomerIdCheckDelete.js">
</script>
...
<form name="deletecustomer" action="CustomerController" method="post">
<input type="hidden" name="operation" value="viewForDelete">
