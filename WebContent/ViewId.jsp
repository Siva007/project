...
<title>Call Details View By Id</title>
...
<td height="410" bordercolor="#89CFF0"width="530" valign="top" >
        <table border="0" bgcolor="#89CFF0"cellspacing="0" width="410" cellpadding="0" height="1" >
          ...
          <tr>
            ...
            Viewing Call Details</b></font></td>
 ...
 <table width="540" height="404" bgcolor="#D3EDF1" >
               <tr valign="middle">
                <td align="center">   
       ...
       <div id="content">
      <br>
<center><h3>View All Call Details</h3></center>
<table align="center"><tr>
<td>
       <center> 
       
       <form>
       <input name="radio"  type="radio" id="rad" onclick="displayTextBox2()"/>
       <label for="choice2"><font color="green">Search By Call ID  </font>
       </label>
       </form>
...
<td height="65"><center>
                ...
                <input type="hidden" name="checkpage" value="id"/></INPUT>
                <font color="#FFAEB9">Enter Call ID  </font><input type="text" name="ID">
               ...
               <%String msg = request.getParameter("msg");if(msg != null){
                ...
                <form name="butval" method="post" action="CallDetailsControllerD" onsubmit="return openpage()">
...
<%
   ...
   if(clist!=null){
%><div style="height:210px;width:510px;border:1px solid #ccc;overflow:scroll;">
...
<th> Connection&nbsp;NO</th>
<th> Call&nbsp;ID&nbsp;</th>
<th width="170" align="center">Date Of Call<br>(YYYY&nbsp;-&nbsp;MM&nbsp;-&nbsp;DD&nbsp;)</th>
</tr>

<%for(int i=0;i<clist.size();i++){%>

<a href='CallDetailsControllerD?callId=<%=clist.get(i).getCallid()%>&checkpage=viewall1'>
<tr ONMOUSEOVER="this.style.backgroundColor='skyblue'" ONMOUSEOUT="this.style.backgroundColor='#D3EDF1'"  title="Click on call ID to View More Details">
