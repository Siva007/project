...
<title>Connection Tariff View</title>
</script>
...
<tr>
<th style="width:20%;">Tariff code</th>
<th style="width:30%;">MonthlyRent</th>
<th style="width:10%;">Local Rate(Ps/sec)</th>
<th style="width:10%;">STD Rate(Ps/sec)</th>
<th style="width:20%;">ISD Rate(Re/sec)</th>
</tr>
...
<tr >
<td>
	<%out.println(t.getTcode());
	%>
</td>

<td>
	<%out.println(t.getMonthlyRental());
	%>
</td>


<td>
	<%out.println(t.getLocal());
	%>
</td>


<td>
	<%out.println(t.getStd());
	%>
</td>


<td>
	<%out.println(t.getIsd());
	%>
</td>
