...
function validate()
{
var mystring= document.updateconnection.connectionNumber.value;
var numcheck=/^[0-9]*$/;
...
<form name="updateconnection" action="ConnectionControllerD" method="post" onsubmit="return validate();">
<input type="hidden" name="option" value="updateconnection">
</td>
<td>
Enter</td><td> Connection</td><td> Number </td>

</td>
<td><input type="text" name="connectionNumber" maxlength="10"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
