...
<td height="410" bordercolor="#89CFF0"width="530" valign="top" >
        <table border="0" bgcolor="#89CFF0"cellspacing="0" width="410" cellpadding="0" height="1" >
          ...
          <tr>
            ...
            Viewing Connection Details</b></font></td>
 ...
 <table width="550" height="404" bgcolor="#D3EDF1" >
               <tr valign="middle">
                <td align="center">   
                <h3><font color="blue">Please click on any connection to view entire details</font></h3><br></br>
   				
<form>

<input type="hidden" name="option" value="onsingle"/>

<div style="height:290px;width:520px;border:1px solid #ccc;overflow:scroll;">
   <table border=1 width="450"  align="center">
     <tr valign="middle" bgcolor="skyblue">
<th style="width:20%;">CustomerId</th>
<th style="width:30%;">Connection Number</th>
...
for(ConnectionIssue c:clist)
{
	%>
	
<a href='ConnectionControllerD?connectionNumber=<%=c.getConnectionNumber()%>&option=singleview'>
 
<tr ONMOUSEOVER="this.style.backgroundColor='skyblue'" ONMOUSEOUT="this.style.backgroundColor='#D3EDF1'"  title="Click to View More Details"> 
<td>
...
<td>
	<%out.println(c.getConnectionNumber());
	%>
</td>
