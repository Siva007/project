...
<a class="stable1" href="Login2Controller?operation=logout">
     ...
     <table bgcolor="#89CFF0" border="0" cellpadding="2" style="border-collapse: collapse" bordercolor="#111111" width="100%" height="525">
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse" bordercolor="#111111" height="221">
              ...
              <tr>
                ...
                <td width="100%" height="197" valign="top">
                               ...
                               <table width="550" height="508" bgcolor="#D3EDF1">
<tr valign="middle">
<td align="center">
<h3><font color="blue">Sorry.</font></h3><h4>The customer cannot be deleted.</h4>
		<h3>Customer has active Connections.</h3>
