...
<a class="stable1" href="Login2Controller?operation=logout">
     ...
     <table bgcolor="#89CFF0" border="0" cellpadding="2" style="border-collapse: collapse" bordercolor="#111111" width="100%" height="459">
...
<td height="410" bgcolor="#FFFFFF" width="530" valign="top" >
        <table border="0" bgcolor="#89CFF0"cellspacing="0" width="410" cellpadding="0" height="1" style="border-left-width: 0; border-bottom-width: 0; border-collapse:collapse" bordercolor="#111111">
          ...
          <tr>
			...
			<td>
			<h3>Congratulations</h3> </td><td><h3><font color=blue><%out.println(request.getAttribute("name")); %></font> on</h3></td> <td><h3>successful</h3> </td><td><h3>registration.</h3></td></tr>
			<tr>
			<td align="right"><h3>Your Login</h3></td><td> <h3>Details :</h3></td></tr>
			<tr>
			<td align="right">Customer Id : </td><td><%out.println(request.getAttribute("customerid")); %></br></td>
			</tr>
			<tr>
			<td align="right">Password    : </td><td><%out.println(request.getAttribute("password")); %></td>
