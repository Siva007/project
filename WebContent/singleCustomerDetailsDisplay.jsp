...
<a class="stable1" href="Login2Controller?operation=logout">
     ...
     <table border="0" cellpadding="0" cellspacing="0" style="border-right-style: solid; border-right-width: 1" bordercolor="#111111" width="703" height="345">
     <tr>
     <td width="672" height="1" bgcolor="#CCFFCC" style="border-left-style: solid; border-left-width: 1; border-bottom-style:solid; border-bottom-width:1" colspan="3" bordercolor="#99CCFF" valign="top">
     ...
     <tr>
     <td width="672" height="14" bgcolor="#89CFF0" style="border-left-style: solid; border-left-width: 1">&nbsp;
     </td>
     <td width="388" height="14" bgcolor="#89CFF0"  >&nbsp;
     </td>
     </tr>
     ...
     <tr>
     <td width="180" height="330" bgcolor="#89CFF0" valign="top" style="border-left-style: solid; border-left-width: 1; border-bottom-style: solid; border-bottom-width: 1">
     <table border="0" cellpadding="2" style="border-collapse: collapse" bordercolor="#111111" width="100%" height="334">
     <tr>
     ...
     <td width="89%" height="140" valign="top"></td>
...
<td height="330" bgcolor="#89CFF0" width="550" style="border-bottom-style: solid; border-bottom-width: 1 "valign="top">
        <table border="0" cellspacing="0" width="101%" cellpadding="0" height="1" style="border-left-width: 0; border-bottom-width: 0; border-collapse:collapse" bordercolor="#111111">
          <tr>
            <td width="2%" height="8" bordercolor="#89CFF0" style="border-left-style: solid; border-left-width: 1"></td>
          ...
          <tr>
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            Personal Details</b></font></td>
            <td width="3%" height="26">&nbsp;</td>
          </tr>
          <tr>
            <td width="2%" height="20" bordercolor="#89CFF0" style="border-left-style: solid; border-left-width: 1">&nbsp;</td>
            <td width="99%" height="20" valign="top">&nbsp;</td>
            
          </tr>
          <tr>
            <td width="2%" height="154" bordercolor="#89CFF0" style="border-left-style: solid; border-left-width: 1">&nbsp;</td>
            <td width="98%" height="154" valign="bottom" bgcolor="#D3EDF1" bordercolor="#C0C0C0">
...
<table  width="520" height="330">

<tr>
<td>


<form name="viewform" action="CustomerController" method="post">


<input type="hidden" name="operation" value="imageDownload"></input>
<input type="hidden" name="id" value="<%=request.getAttribute("custid")%>"> </input>
...
<tr>
<td>Customer Id: </td>
<td><%out.println(request.getAttribute("custid")); %></td>
</tr>
<tr>
<td>Customer Name: </td>
<td>
...
<tr>
<td>Date Of Birth: </td>
<td><%out.println(request.getAttribute("dob")); %></td>
</tr>
<tr>
<td>Gender: </td>
<td><%out.println(request.getAttribute("gen")); %></td>
</tr>
<tr>
<td>Contact Number: </td>
<td><%out.println(request.getAttribute("num")); %></td>
</tr>
<tr>
<td>Email Id: </td>
<td><%out.println(request.getAttribute("mail")); %></td>
</tr>
<tr>
<td>ID Proof: </td>
<td><%out.println(request.getAttribute("proof")); %></td>
</tr>
...
<form name="viewform1" action="CustomerController" method="post">


<input type="hidden" name="operation" value="addressImageDownload"></input>
<input type="hidden" name="id" value="<%=request.getAttribute("custid")%>"> </input>
<td>Address Proof: </td>
<td><%out.println(request.getAttribute("AddressProof")); %></td>
</tr>
...
<td><input type="submit"  value="Download" /></td>         
          ...
          <tr>
            <td width="2%" height="18" bordercolor="#89CFF0" style="border-left-style: solid; border-left-width: 1; border-bottom-style:none; border-bottom-width:medium"></td>
